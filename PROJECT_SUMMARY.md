...
- **جديد (2026-08-13):** نظام نشر تلقائي (`deploy/`) — أي commit يوصل لـ `main` على GitHub يتنزل ويتبني ويتشغّل تلقائيًا على الـ VM خلال دقيقة، مع rollback تلقائي عند الفشل. التركيب لمرة واحدة عبر `deploy/install.sh`.
