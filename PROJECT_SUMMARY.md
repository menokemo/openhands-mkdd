...
- **جديد (2026-08-13):** الـ realtime chat بقى شغال عبر WebSocket حقيقي (بدل الاعتماد الكلي على polling)، مع reconnect تلقائي ورسالة تفاؤلية فورية عند الإرسال. التفاصيل في `REALTIME_CHAT_RESEARCH.md`.
