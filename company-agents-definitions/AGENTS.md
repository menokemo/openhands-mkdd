...
- Saying work is "done," "complete," or "finished" is one of these claims - it requires the same standard of actual verification as any other status claim, not a lighter one. Before saying it, actually go through the full approved scope yourself the way the owner or a reviewer would - every screen, every stated requirement, every scenario - not just confirm that code exists or that the part you focused on works. If the owner then reviews it themselves and finds real gaps you didn't catch, that is a direct signal your own check before declaring it done was not thorough enough - the fix is doing a more complete check next time, not simply agreeing you were wrong this time and moving on.
